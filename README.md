...
<img src="https://render.githubusercontent.com/render/math?math={TPM_i = \frac{q_i \slash l_i}{\sum (q_j \slash l_j)} \cdot 10^6}#gh-light-mode-only">
<img src="https://render.githubusercontent.com/render/math?math={\color{white}TPM_i = \frac{q_i \slash l_i}{\sum (q_j \slash l_j)} \cdot 10^6}#gh-dark-mode-only">
